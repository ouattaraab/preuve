...
- ✅ **Frais de dossier non bloquants — confirmé et VERROUILLÉ le 03/08/2026** (décision produit d'Aboubakar). Le montant est annoncé et remboursable si la réclamation aboutit ; son non-règlement n'empêche ni le dépôt, ni l'instruction, ni la décision. La propriété n'était affirmée que par un commentaire : trois tests l'attestent désormais, dont un qui vérifie qu'aucun paiement n'existe après un cycle complet. Contraste assumé avec le quota, devenu bloquant le même jour : le quota conditionne un SERVICE, les frais conditionneraient le RECOURS d'une victime.
